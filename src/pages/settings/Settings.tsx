...
export default function Settings() {
  ...
  const { employees, addEmployee, removeEmployee, assignTableToWaiter, unassignTableFromWaiter, shift, openShift, closeShift, businessName, setBusinessName, tableZones, addTableZone, removeTableZone } = useSettingsStore();
